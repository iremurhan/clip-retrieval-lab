...
Usage (stage 2 — single process per mode):
    python scripts/precompute_sam.py --seg_mode spatial     --output_dir datasets/coco/sam_masks
    python scripts/precompute_sam.py --seg_mode semantic    --output_dir datasets/coco/sam_masks \
        --dataset coco --image_dir datasets/coco \
        --coco_annotations datasets/coco/annotations
    python scripts/precompute_sam.py --seg_mode continuous  --output_dir datasets/coco/sam_masks
"""
